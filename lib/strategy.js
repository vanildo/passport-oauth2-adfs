...
var passport = require('passport-strategy')
  ...
  , util = require('util')
  , utils = require('./utils')
  , OAuth2 = require('./node_modules/oauth/lib/oauth2').OAuth2
...
function OAuth2Strategy(options, verify) {
  ...
  this._oauth2 = new OAuth2(options.clientID,  options.clientSecret,
      '', options.authorizationURL, options.tokenURL, options.customHeaders, options.resource, options.callbackURL);
